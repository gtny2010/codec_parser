...
typedef struct HEVCPPS {
  ...
  int num_ref_idx_l0_default_active; ///< num_ref_idx_l0_default_active_minus1 +
                                     ///< 1
  int num_ref_idx_l1_default_active; ///< num_ref_idx_l1_default_active_minus1 +
                                     ///< 1
...
int ff_hevc_encode_nal_vps(HEVCVPS *vps, unsigned int id, uint8_t *buf,
                           int buf_size);
