...
#define MB_TYPE_INTRA                                                          \
  MB_TYPE_INTRA4x4 // default mb_type if there is just one type
...
#define IS_INTER(a)                                                            \
  ((a) & (MB_TYPE_16x16 | MB_TYPE_16x8 | MB_TYPE_8x16 | MB_TYPE_8x8))
...
//                          int16_t (*motion_val[2])[2], int mb_width, int
//                          mb_height, int mb_stride, int quarter_sample);
